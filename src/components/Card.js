    ...
    <li className="places__item">
      <figure className="place-card places__card">
        {isOwn && <button type="button" aria-label="Удалить"
                          className="button-delete opacity-effect place-card__delete" onClick={handleDeleteClick}></button>}
        ...
        <figcaption className="place-card__body">
          ...
          <div className="place-card__likes">
            <button type="button" className={`button-like ${isLiked && 'button-like_active'} opacity-effect place-card__like`} onClick={handleLikeClick}></button>
